...
export function Modal({ open, title, onClose, children, closeLabel = "Fermer" }: { open: boolean; title: string; onClose: () => void; children: React.ReactNode; closeLabel?: string }) {
  ...
  <div className="modal-panel w-full h-[100dvh] md:h-auto md:max-h-[85vh] md:w-auto md:max-w-2xl rounded-none md:rounded-2xl border border-slate-300 bg-white shadow-xl overflow-hidden dark:border-white/10 dark:bg-slate-900">
